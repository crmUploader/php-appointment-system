                        ...
                        <tbody>
                            ...
                            <?php
                                        ...
                                        <form action="booking-complete.php" method="POST">
                                            ...
                                            <input type="hidden" name="docname" value="<?php echo $docname; ?>">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px; width:95%; text-align: center;" value="Book now" name="booknow">
                                                </td>
                                            </tr>
                                        </form>
                                        <?php
